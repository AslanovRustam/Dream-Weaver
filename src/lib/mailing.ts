...
import { DEFAULT_EMAIL_ACCENT, DEFAULT_EMAIL_BASE, EMAIL_GAMMAS, isHex } from "./emailPalette";
...
/** Светлая база для черновиков, сохранённых со старым `dark: false`. */
const LEGACY_LIGHT_BASE = EMAIL_GAMMAS.find((g) => g.id === "paper")!.base;
